...
class YTVOSDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        while not instance_check:
            ...
            all_indx = list(range(vid_len))
            sampled_relative_indices = [all_indx.index(i) for i in sample_indx]
            ...
            for f_idx in all_indx:
                img_path = os.path.join(str(self.img_folder), 'JPEGImages', video, frames[f_idx] + '.jpg')
                img_beit = self.transforms_beit(Image.open(img_path).convert('RGB'))
                imgs_beit.append(img_beit)
