...
from tools.data.a2d_sentences import a2d_sentences_dataset

subset_type = 'test'
dataset_path = '../../../dataset/RVOS/a2d_sentences'
output_path = f'outputs/a2d_sentences_{subset_type}_annotations_in_coco_format.json'
