...
def read_split_set(data_root='../../dataset/davis'):
...
def mv_images_to_folder(data_root='../../dataset/davis', output_root='data/ref-davis'):
...
def create_meta_expressions(data_root='../../dataset/davis', output_root='../../dataset/davis'):
    """
...
def create_meta_annotaions(data_root='../../dataset/davis', output_root='../../dataset/davis'):
    """
